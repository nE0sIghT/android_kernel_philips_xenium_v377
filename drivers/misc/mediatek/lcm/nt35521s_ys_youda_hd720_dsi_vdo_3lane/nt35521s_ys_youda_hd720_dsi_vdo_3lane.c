...
static unsigned int lcm_compare_id(void)
{
	...
	unsigned int lcm_id = 0,mod_id = 0;
...
#ifdef BUILD_LK
	printf("LK,NT35521C: id1=0x%x,id2=0x%x,mod_id=0x%x\n",id1,id2,mod_id);   
#else
	printk("KERNEL,NT35521C: id1=0x%x,id2=0x%x,mod_id=0x%x\n",id1,id2,mod_id);  
#endif

	if ((NT35521_LCM_ID == lcm_id)&&(mod_id==0x99))
		return 1;
	else
		return 0;
...
LCM_DRIVER nt35521s_ys_youda_hd720_dsi_vdo_3lane_lcm_drv = 
{
    .name			= "nt35521s_ys_youda_hd720_dsi_vdo_3lane",
