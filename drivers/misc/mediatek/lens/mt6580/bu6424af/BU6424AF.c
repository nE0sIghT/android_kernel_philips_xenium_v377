...
#define BU6424AF_SLAVE_I2C_ADDRESS		0x18
#define BU6424AF_I2C_REGISTER_ID		0x22

#define BU6424AF_PLATFORM_DRIVER_NAME "lens_actuator_bu6424af"
#define BU6424AF_AF_DRIVER_CLASS_NAME "actuatordrv_bu6424af"

static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO(BU6424AF_DRVNAME, BU6424AF_I2C_REGISTER_ID)};
...
unsigned long a_u4Param)
{
    ...
    //printk("davidpeng---,BU6424AF_Ioctl,=====\n");
...
/*tydrv qupw add for set bu6424 af begin */
//set bu64241 enable ICRC mode.
static int bu64241_set_mode(void)
{
	//
	int  i4RetValue = 0;
	int i;
	...
	//pintA 80, intB 100 ,f0 50HZ, str 7, stt 1400us. //according truly valueset
	char puSendCmd[8] = {0xcc,0x3b,0xd4,0x50,0xdc,0x64,0xe4,0x41};
	...
	for(i=0;i<4;i++)
	{
		i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, ptmpcmd, 2);
...
/*tydrv qupw add for truly vcm end*/
...
static int BU6424AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
	...
	/*tydrv qupw add for truly vcm begin*/
	bu64241_set_mode();
	/*tydrv qupw add for truly vcm end*/
...
inline static int Register_BU6424AF_CharDrv(void)
{
	...
	actuator_class = class_create(THIS_MODULE, BU6424AF_AF_DRIVER_CLASS_NAME);
...
static int BU6424AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstBU6424AF_I2Cclient->addr = BU6424AF_SLAVE_I2C_ADDRESS;
...
static struct platform_driver g_stBU6424AF_Driver = 
{
    ...
    .driver		= {
		   .name = BU6424AF_PLATFORM_DRIVER_NAME,
        .owner	= THIS_MODULE,
    }
};
