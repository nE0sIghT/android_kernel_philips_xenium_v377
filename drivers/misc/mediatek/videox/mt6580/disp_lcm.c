...
#include "disp_lcm.h"
#include <linux/proc_fs.h>   //proc file use //added by yulin 2015/11/26
...
static  struct file_operations flcm_proc_fops = {
    .owner = THIS_MODULE,
...
disp_lcm_handle* disp_lcm_probe(char* plcm_name, LCM_INTERFACE_ID lcm_id)
{
	...
	g_lcm_drv = NULL; //added by yulin 2015/11/26
	...
	g_lcm_drv = lcm_drv; //added by yulin 2015/11/26
    proc_create(PROC_LCM_INFO, 0, NULL, &flcm_proc_fops);	
