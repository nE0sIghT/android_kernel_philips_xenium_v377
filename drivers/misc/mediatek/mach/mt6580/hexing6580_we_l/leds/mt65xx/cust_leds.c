...
extern int Lentek_Led_Red_Light_Control(int level);
extern int Lentek_Led_Green_Light_Control(int level);
extern int Lentek_Led_Blue_Light_Control(int level);
