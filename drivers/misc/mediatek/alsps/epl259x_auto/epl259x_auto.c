...
extern struct alsps_hw *epl259x_get_cust_alsps_hw(void);//added by pengwei 20160407
...
static void initial_global_variable(struct i2c_client *client, struct epl_sensor_priv *obj)
{
    ...
    dynk_low_offset = 500;//500;
    dynk_high_offset = 800;//800;
#endif /*PS_DYN_K*/
...
static void epl_sensor_power(struct alsps_hw *hw, unsigned int on)
{
    ...
    {
    	//delete by pengwei 20150717 begin
    	#if 0
        if(power_on == on)
        {
		...
		#endif
		//delete by pengwei 20150717 end
    }
    power_on = on;
}
