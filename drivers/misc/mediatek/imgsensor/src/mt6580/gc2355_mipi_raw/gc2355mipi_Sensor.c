...
static imgsensor_info_struct imgsensor_info = {
    ...
    .cap_delay_frame = 1,        //enter capture delay frame num //modified by yulin for cts 3->1
    .pre_delay_frame = 1,         //enter preview delay frame num //modified by yulin for cts 3->1
    .video_delay_frame = 1,        //enter video delay frame num //modified by yulin for cts 3->1
...
/////////////////////////////////////////////////////
	...
	write_cmos_sensor(0x17,0x17);//mirror, 0x17
