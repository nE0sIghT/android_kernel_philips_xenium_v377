...
static kal_uint8 TestPatternModeFlag=0;
...
{	
	...
	SIOSENSOR_INFO("[ABC]---------------20150605zoe---------iShutter=%d,HM8131SensorDriver.FrameHeight=%d----------------------------------",iShutter,HM8131SensorDriver.FrameHeight);
...
UINT32 HM8131MIPIPreview(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window, MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (TestPatternModeFlag)
    {
        HM8131MIPI_write_cmos_sensor(0x3110,0x00);
        HM8131MIPI_write_cmos_sensor(0x4144,0x00);
        HM8131MIPI_write_cmos_sensor(0x4145,0x00);
        HM8131MIPI_write_cmos_sensor(0x4146,0x00);
        HM8131MIPI_write_cmos_sensor(0x0601,0x02);
    }
...
UINT32 HM8131SetTestPatternMode(kal_bool bEnable)
{
	...
	{
		TestPatternModeFlag = 0;
		HM8131MIPI_write_cmos_sensor(0x0601, 0x00);
	}
...
#define HM8131_MIPI_RAW_CHECKSUM_VALUE		0x96379a25
  ...
  //  unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	...
	switch( FeatureId )
	{
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE: //for factory mode auto testing
			*pFeatureData32 = HM8131_MIPI_RAW_CHECKSUM_VALUE;
			*pFeatureParaLen = 4;
			break;
