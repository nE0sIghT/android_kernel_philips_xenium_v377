...
#else
#define	HM8131MIPI_PREVIEW_CLK	 34000  //35 
#define	HM8131MIPI_VIDEO_CLK    34000   //35
#define	HM8131MIPI_CAPTURE_CLK	 34000  //68Mhz

#endif

/*First Bayer Color*/
#define HM8131MIPI_COLOR_FORMAT	SENSOR_OUTPUT_FORMAT_RAW_B	//SENSOR_OUTPUT_FORMAT_RAW_B
...
//#else
		{0x0111,0x00}, //2 1 ; B5: 1'b0:2lane, 1'b1:4lane (org 4B19)
