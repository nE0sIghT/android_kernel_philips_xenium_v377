...
extern int read_gs8604_eeprom_mtk_fmt(void);
#endif
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = GS8604_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
UINT32 GS8604MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
