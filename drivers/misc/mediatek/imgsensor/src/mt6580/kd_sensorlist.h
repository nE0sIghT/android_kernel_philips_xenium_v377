...
ACDK_KD_SENSOR_INIT_FUNCTION_STRUCT kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR+1] =
{
	...
	{IMX179_SENSOR_ID, SENSOR_DRVNAME_IMX179_MIPI_RAW,IMX179_MIPI_RAW_SensorInit},//800W
#endif

#if defined(OV8858_MIPI_RAW)
    {OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW,OV8858_MIPI_RAW_SensorInit},//800W
#endif

#if defined(HM8131_MIPI_RAW)
    {HM8131MIPI_SENSOR_ID, SENSOR_DRVNAME_HM8131_MIPI_RAW,HM8131MIPI_RAW_SensorInit},//800W
#endif

#if defined(GS8604MIPI_RAW)
    {GS8604_SENSOR_ID, SENSOR_DRVNAME_GS8604_MIPI_RAW, GS8604MIPI_RAW_SensorInit},//800W
#endif

#if defined(HI841_MIPI_RAW)
    {HI841_SENSOR_ID, SENSOR_DRVNAME_HI841_MIPI_RAW, HI841_MIPI_RAW_SensorInit},//800W
#endif

#if defined(SP8408_MIPI_RAW)
    {SP8408MIPI_SENSOR_ID, SENSOR_DRVNAME_SP8408_MIPI_RAW, SP8408_MIPI_RAW_SensorInit},//800W
#endif

#if defined(GC8024MIPI_RAW)
    {GC8024MIPI_SENSOR_ID, SENSOR_DRVNAME_GC8024MIPI_RAW, GC8024MIPI_RAW_SensorInit},//800W
#endif

#if defined(OV5648_MIPI_RAW)
    {OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW, OV5648MIPISensorInit},//500W
#endif

#if defined(OV5670_MIPI_RAW)
    {OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW, OV5670_MIPI_RAW_SensorInit},//500W
#endif

#if defined(HI551_MIPI_RAW)
    {HI551_SENSOR_ID, SENSOR_DRVNAME_HI551_MIPI_RAW, HI551_MIPI_RAW_SensorInit},//500W
#endif

#if defined(GC5024_MIPI_RAW)
    {GC5024MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5024_MIPI_RAW, GC5024MIPI_RAW_SensorInit},//500W
#endif

#if defined(GC5005MIPI_RAW)
    {GC5005MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5005MIPI_RAW, GC5005MIPI_RAW_SensorInit},//500W
#endif

#if defined(HI553_MIPI_RAW)
    {HI553_SENSOR_ID, SENSOR_DRVNAME_HI553_MIPI_RAW, HI553_MIPI_RAW_SensorInit},//500W
#endif

#if defined(GC2355_MIPI_RAW)
    {GC2355_SENSOR_ID, SENSOR_DRVNAME_GC2355_MIPI_RAW, GC2355_MIPI_RAW_SensorInit},//200W
#endif

#if defined(GC0310_YUV)
    {GC0310_SENSOR_ID, SENSOR_DRVNAME_GC0310_YUV, GC0310_YUV_SensorInit},//30W
#endif
