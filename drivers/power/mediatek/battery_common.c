...
//added by yulin {
static ssize_t show_ICharging_Value(struct device *dev,struct device_attribute *attr,
					char *buf)
{
	kal_int32 ICharging;
...
static DEVICE_ATTR(ICharging_Value, 0664, show_ICharging_Value, NULL);
//added by yulin }
...
//modified by wkp 20151119 begin
...
#endif
//added by yulin {
		ret_device_file = device_create_file(&(dev->dev), &dev_attr_ICharging_Value);
//added by yulin }
